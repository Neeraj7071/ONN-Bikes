...
async function dta(){
    try {
        const res= await fetch(`https://onnbike-clone.herokuapp.com/citybikes/${cityname}`);
...
console.log(cityname)
    try {
        let result = await fetch(`https://onnbike-clone.herokuapp.com/areas/${cityname}`);
            ...
            button.addEventListener("click",()=>{
                async function cartdata(){
                    ...
                    try {
                        ...
                        let res = await fetch(
                            "https://onnbike-clone.herokuapp.com/",
                            {
                              method: `POST`,
                              body: objcityname,
                              headers: {
